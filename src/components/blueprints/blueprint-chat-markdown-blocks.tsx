...
import { splitInlineMarkdown } from "@/lib/blueprints/parse-chat-markdown"
...
type BlueprintChatMarkdownBlocksProps = {
  blocks: ChatMarkdownBlock[]
}

export function BlueprintChatMarkdownBlocks({
  blocks,
}: BlueprintChatMarkdownBlocksProps) {
  return (
    <>
